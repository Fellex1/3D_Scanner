...
from PyQt6.QtWidgets import (
    ...
    QPushButton, QLabel, QFrame, QSizePolicy, QStackedWidget, QScrollArea, QToolButton
)
    ...
    def load_pages(self, language):
        ...
        if language == "de":
            self.add_page("Startseite", 
                        [("title", "3D-Scanner Interface"), "Interface um den 3D-Scanner zu bedienen", "'Text'",("button","Auf USB-Stick laden")])
            ...
            self.add_page("Pagina Iniziale",
                        [("title", "3D-Scanner Interface"), "Interfaccia per gestire lo scanner 3D", "'Testo'", ("button","Carica su USB")])
            ...
            self.add_page("Home",
                        [("title", "3D Scanner Interface"), "Interface to operate the 3D scanner", "'Text'", ("button", "Load to USB")])
    ...
    def _make_widget(self, item):
        if isinstance(item, tuple):
            if item[0] == "button":
                ...
                btn.clicked.connect(lambda _, t=item[1]: print(f"Button {t} gedrückt"))
                return btn
