"""=======TODO-Liste v0.6=======
Barcode-Scan in GUI integrieren
Abmessung und Gewicht in GUI integrieren
Seitenübergänge flüssiger gestalten zwischen idex 1 und 2 bei zweitem durchlauf
...
class FullscreenApp(QMainWindow):
    def __init__(self):
        ...
        self.images = [None, None, None, None]  # Platzhalter für die 4 Bilder
        self.image_labels = [None, None, None, None]  # Labels für die Bilder
